...
public class Line {
    ...
    public Line(Integer active, String account0, String account16, Integer lineId, Integer groupProviderId, String name, String order, String registrationDate, Integer registrationUser) {
        this.active = active;
